function [panel_head_ready2, mask_head]= headPartMask(panel,panel_seg2,panel_ed5,mask2,mask3)
    %Focus on the head region in order to take care of the diverse antennae issue
    ...
    %Examine the connection between antennae and head
    ...
    %create a negative mask of refined head region
