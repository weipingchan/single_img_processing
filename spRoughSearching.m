...
%Roughly search the location of all specimens
    % Make a thumbnail for initial processing 
    ref_thumbnail=imresize(ref,1/shrinkBase,'method','bilinear');
    [nrow,ncol]=size(ref);

    %Find objects in thumbnail
    ...
    panel_edm=imclearborder(panel_ed,4); %Remove area beyond panel 
