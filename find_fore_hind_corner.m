...
intersectSegCountDiff3([IdxLinear,IdxStd])=2; %points show the disconnectivity to its neighbor
intersectSegCountDiff4=intersectSegCountDiff2.*intersectSegCountDiff3;
intersectSegCountDiff4(intersectSegCountDiff4<0)=0;

%Use all two indices to determine the target segment line
...
%If the number of closest 2 points is less than 2, find the nearest 2 on
