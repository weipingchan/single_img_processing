...
%ref value; cmscale: pixels/1cm
 ...
 disp('Start to rescale the reflectance based on the value of references.');
 ...
 disp(['Band white has been rescaled based on the reflectance of references.']);
...
disp(['Variable [px0]: [',num2str(px0(1)),',',num2str(px0(2)),',',num2str(px0(3)),']']);
disp(['Variable [px1]: [',num2str(px1(1)),',',num2str(px1(2)),',',num2str(px1(3)),']']);
disp(['Band whitePolarized 1 has been rescaled based on the reflectance of references.']);
...
disp(['Variable [px0]: [',num2str(px0(1)),',',num2str(px0(2)),',',num2str(px0(3)),']']);
disp(['Variable [px1]: [',num2str(px1(1)),',',num2str(px1(2)),',',num2str(px1(3)),']']);
disp(['Band whitePolarized 2 has been rescaled based on the reflectance of references.']);
...
disp(['Variable [px0]: [',num2str(px0(1)),',',num2str(px0(2)),',',num2str(px0(3)),']']);
disp(['Variable [px1]: [',num2str(px1(1)),',',num2str(px1(2)),',',num2str(px1(3)),']']);
disp(['Band NearIR740 has been rescaled based on the reflectance of references.']);
...
disp(['Variable [px0]: [',num2str(px0(1)),',',num2str(px0(2)),',',num2str(px0(3)),']']);
disp(['Variable [px1]: [',num2str(px1(1)),',',num2str(px1(2)),',',num2str(px1(3)),']']);
disp(['Band NearIR940 has been rescaled based on the reflectance of references.']);
...
disp(['Band UV has been rescaled based on the reflectance of references.']);
...
disp(['Band UVFluorescence has been rescaled based on the reflectance of references.']);

%UV with RGB reflectance bands
 UV3bands=imReScaleRGB(imgs{3}, px0UV,px1UV);
 Wbalance{8}= UV3bands;
 disp(['Band UV in RGB has been rescaled based on the reflectance of references.']);
 clear UV3bands

%UVF with RGB reflectance bands
 UVF3bands=imReScaleRGB(imgs{4}, px0UVF,px1UVF);
 Wbalance{9}= UVF3bands;
 disp(['Band UVFluorescence in RGB has been rescaled based on the reflectance of references.']);
 clear UVF3bands
